...
<div class="jumbotron jumbotron-fullheight jumbo-vertical-center text-light text-center bg-dark mb-0 radius-0">
  <div class="container">
      ...
      <h1 class="display-2 text-light text-uppercase">Well done!</h1>


    <form action="/" method="get">
      <input class="btn btn-outline-light btn-hover-text-dark btn-wide btn-lg m-2" type="submit" value="Go back"/>
    </form>
  </div>
</div>
